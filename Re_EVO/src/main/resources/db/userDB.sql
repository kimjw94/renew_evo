...
--ADMIN 계정 만들기(예시용)
INSERT INTO EVO_USER_ACCOUNT (USER_NO,USER_LOGIN_ID,USER_PASSWORD,USER_ENABLED)
VALUES (EVO_USER_SEQ.NEXTVAL,'admin','$2a$10$fsdbguK5X9iHXlB/yDYP/.8OADBcvjhegCQL8.CGTh9SX54RnxTK6','Y');

SELECT*FROM EVO_USER_ACCOUNT WHERE USER_LOGIN_ID='admin';

INSERT INTO EVO_USER_PROFILE (USER_NO, USER_NAME, USER_BIRTHDAY, USER_EMAIL, USER_GENDER, USER_PHONE)
VALUES (21, '관리자', SYSDATE, 'admin@admin', 'M', '010-0000-0000');

INSERT INTO EVO_USER_ROLE (USER_ROLE_NO, USER_NO, ROLE_NO)
VALUES (EVO_USER_ROLE_SEQ.NEXTVAL, 21, 2);

SELECT * FROM EVO_USER_ACCOUNT A 
LEFT JOIN EVO_USER_ADDRESS AD ON A.USER_NO = AD.USER_NO
LEFT JOIN EVO_USER_PROFILE P ON A.USER_NO = P.USER_NO
LEFT JOIN EVO_USER_ROLE R ON A.USER_NO =R.USER_NO
WHERE A.USER_LOGIN_ID = 'admin';
